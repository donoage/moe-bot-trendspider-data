...
def main():
    ...
    parser.add_argument('--tickers', nargs='+', help='Specific tickers to process (default: all from ticker_list.json)')
    ...
    if args.tickers:
        ...
        print(f"Processing all tickers from ticker_list.json: {len(tickers)} tickers")
